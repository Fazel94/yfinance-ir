...
Options for continuing after 2026.9.2, which shipped as a GitHub release only. Cash-flow statements, option chains and intraday bars shipped in 2026.9.2.

## Publish to PyPI

Deferred at 2026.9.1 and 2026.9.2. `https://pypi.org/pypi/yfinance-ir/json` returned 404 on 2026-09-24, so the name was free then; nothing reserves it until the first upload.
